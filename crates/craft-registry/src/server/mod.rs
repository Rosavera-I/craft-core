...
impl Server {
    ...
    fn build_routes(
        ...
        let protected = Router::new()
            ...
            // Team routes
            .route("/api/v1/orgs/:org_name/teams/:team_name", get(get_team_handler))
            .route("/api/v1/orgs/:org_name/teams/:team_name", put(update_team_handler))
            .route("/api/v1/orgs/:org_name/teams/:team_name", delete(delete_team_handler))
            .route("/api/v1/orgs/:org_name/teams/:team_name/members", get(list_team_members_handler))
            .route("/api/v1/orgs/:org_name/teams/:team_name/members", post(invite_team_member))
            .route("/api/v1/orgs/:org_name/teams/:team_name/members/:user_id", delete(remove_team_member))
            // Harness routes
