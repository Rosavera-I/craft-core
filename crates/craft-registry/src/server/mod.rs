...
impl Server {
    ...
    fn build_routes(
        ...
        let protected = Router::new()
            ...
            .route("/api/v1/orgs/:name/members", post(invite_org_member))
            .route("/api/v1/orgs/:name/members/:username", delete(remove_org_member))
            .route("/api/v1/orgs/:name/teams", get(list_teams_handler))
            .route("/api/v1/orgs/:name/teams", post(create_team_handler))
            // Team routes
            .route("/api/v1/teams/:org/:name", get(get_team_handler))
            .route("/api/v1/teams/:org/:name", put(update_team_handler))
            .route("/api/v1/teams/:org/:name", delete(delete_team_handler))
            .route("/api/v1/teams/:org/:name/members", get(list_team_members_handler))
            .route("/api/v1/teams/:org/:name/members", post(invite_team_member))
            .route("/api/v1/teams/:org/:name/members/:username", delete(remove_team_member))
            // Harness routes
